  ...
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "神棍短链接": "https://modevil.dpdns.org/short",
        },
        customBackend: {
          "MetaCubeX后端": "https://sub.modevil.dpdns.org",
        },
        backendOptions: [
          {value: "https://sub.modevil.dpdns.org"},
        ],
        remoteConfig: [
          {
            label: "神棍订阅",
            options: [
              {
                label: "神棍-订阅 (与Github同步)",
                value: "https://raw.githubusercontent.com/siren202101/clash/refs/heads/main/private.ini"
              },
              {
                label: "神棍-去广告精简版-订阅 (与Github同步)",
                value: "https://raw.githubusercontent.com/siren202101/clash/refs/heads/main/private_AdvertisingLite.ini"
              },
              {
                label: "神棍-去广告完整版-订阅 (与Github同步)",
                value: "https://raw.githubusercontent.com/siren202101/clash/refs/heads/main/private_Advertising.ini"
              },
              {
                label: "神棍-本地-订阅",
                value: "private/private.ini"
              },
              {
                label: "神棍-去广告精简版-本地-订阅",
                value: "private/private_AdvertisingLite.ini"
              },
              {
                label: "神棍-去广告完整版-本地-订阅",
                value: "private/private_Advertising.ini"
              }
            ]
          },
          {
    ...
    getBackendVersion() {
      this.$axios
          ...
          .then(res => {
            ...
            let a = this.form.customBackend.indexOf("url.modevil.dpdns.org") !== -1 || this.form.customBackend.indexOf("sub.modevil.dpdns.org") !== -1;
